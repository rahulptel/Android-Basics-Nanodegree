    ...
    private static List<Book> extractFeatureFromJson(String booksJSON) {
        ...
        try {
            ...
            for (int i = 0; i < booksArray.length(); i++) {
                Log.d(LOG_TAG, "" + i);
                JSONObject currBookJSON = booksArray.getJSONObject(i);
                JSONObject currBookVolInfoJSON = currBookJSON.getJSONObject("volumeInfo");
                String title = currBookVolInfoJSON.getString("title");
                String author = "";
                JSONArray authorsArray = currBookVolInfoJSON.getJSONArray("authors");
                int j = 0;
