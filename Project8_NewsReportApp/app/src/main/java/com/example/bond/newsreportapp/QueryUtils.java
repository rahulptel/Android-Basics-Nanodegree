...
public class QueryUtils {
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            // Extract out the response JSONObject
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                // Get a single news at position i within the list of newsArray
                JSONObject currentNews = newsArray.getJSONObject(i);

                // Extract the title of the news
                String title = currentNews.getString("webTitle");
                // Extract the section of the news
                String section = currentNews.getString("sectionName");
                // Extract the url of the news
                String url = currentNews.getString("webUrl");

                // Create a new News object with the title, section and url
